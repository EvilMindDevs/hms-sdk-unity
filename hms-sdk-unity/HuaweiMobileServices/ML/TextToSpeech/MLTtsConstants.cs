...
namespace HuaweiMobileServices.ML.TextToSpeech
{
    ...
    public class MLTtsConstants: JavaObjectWrapper
    {
        ...
        public static string TTS_SPEAKER_OFFLINE_AR_AR_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_AR_AR_FEMALE_FLY));
        ...
        public static string TTS_SPEAKER_OFFLINE_DE_DE_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_DE_DE_FEMALE_FLY));
        ...
        public static string TTS_SPEAKER_OFFLINE_EN_US_FEMALE_BOLT => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_EN_US_FEMALE_BOLT));
        public static string TTS_SPEAKER_OFFLINE_EN_US_MALE_BOLT => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_EN_US_MALE_BOLT));
        public static string TTS_SPEAKER_OFFLINE_EN_US_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_EN_US_FEMALE_FLY));
        ...
        public static string TTS_SPEAKER_OFFLINE_ES_ES_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_ES_ES_FEMALE_FLY));
        ...
        public static string TTS_SPEAKER_OFFLINE_FR_FR_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_FR_FR_FEMALE_FLY));
        ...
        public static string TTS_SPEAKER_OFFLINE_IT_IT_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_IT_IT_FEMALE_FLY));
        public static string TTS_SPEAKER_OFFLINE_RU_RU_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_RU_RU_FEMALE_FLY));
        public static string TTS_SPEAKER_OFFLINE_TH_TH_FEMALE_FLY => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_TH_TH_FEMALE_FLY));
        ...
        public static string TTS_SPEAKER_OFFLINE_ZH_HANS_FEMALE_BOLT => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_ZH_HANS_FEMALE_BOLT));
        public static string TTS_SPEAKER_OFFLINE_ZH_HANS_MALE_BOLT => sJavaClass.GetStatic<string>(nameof(TTS_SPEAKER_OFFLINE_ZH_HANS_MALE_BOLT));
        #endregion  
