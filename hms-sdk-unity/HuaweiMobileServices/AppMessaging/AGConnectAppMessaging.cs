...
namespace HuaweiMobileServices.AppMessaging
{
    public class AGConnectAppMessaging : JavaObjectWrapper
    {
        ...
        public static AGConnectAppMessaging Instance => androidJavaClass.CallStaticAsWrapper<AGConnectAppMessaging>("getInstance");
        ...
        public void AddOnClickListener(Action<AppMessage> listener) => Call("addOnClickListener", new AGConnectAppMessagingOnClickListenerWrapper(listener));

        public void AddOnDismissListener(Action<AppMessage, DismissType> listener) => Call("addOnDismissListener", new AGConnectAppMessagingOnDismissListenerWrapper(listener));
