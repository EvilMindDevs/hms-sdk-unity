...
namespace HuaweiMobileServices.Drive
{
    public class About : JavaObjectWrapper
    {
        ...
        public bool IsNeedUpdate() => Call<bool>("isNeedUpdate");
        ...
        public long GetMaxFileUploadSize() => Call<long>("getMaxFileUploadSize");
        ...
        public long GetMaxThumbnailSize() => Call<long>("getMaxThumbnailSize");
        ...
        public class StorageQuota : JavaObjectWrapper
        {
            ...
            public long GetUserCapacity() => Call<long>("getUserCapacity");
            public StorageQuota SetUserCapacity(long var1) => CallAsWrapper<StorageQuota>("setUserCapacity", var1);
            public long GetUsedSpace() => Call<long>("getUsedSpace");
